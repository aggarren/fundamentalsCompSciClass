...
LinkedList::~LinkedList(){
  ...
  CPSC170/Homework/aggarren-Homework7/Homework7.txt                                                   0000640 0014416 0014416 00000001615 14221455507 022072  0                                                                                                    ustar   aggarren                        aggarren                                                                                                                                                                                                               Test Cases:

test1
input:3 4 5 -1 -2 7 -1
output:34
explanation: this tests using a result of addition in a multiplication equation whose result is used in addition

test2
input:4 5 7 2 -1 -2 -1
output: 49
explanation:this tests using a result of addition in a multiplication equation whose result is used in
